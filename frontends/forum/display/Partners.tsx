          ...
          {partners?.map((item) => {
            return (
              <a
                href={item.url}
                target="_blank"
                class="flex h-[120px] w-full cursor-pointer touch-manipulation overflow-hidden rounded-[10px] pb-[10px] pt-[10px] text-center [border:var(--btnR)_solid_#01c8ab]"
              >
                <img
                  class="m-auto block max-h-[100%] max-w-[82%] align-top"
