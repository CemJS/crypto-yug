...
export default function () {
  return (
    <div class="wrapper flex flex-col items-center justify-between gap-4 overflow-hidden px-2 @600:flex-row [&_div]:h-[200px] [&_div]:w-full @600:[&_div]:h-[300px] @600:[&_div]:w-1/3">
      <div>
        <iframe
          width="100%"
          height="100%"
